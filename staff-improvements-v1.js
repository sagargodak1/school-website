...
(() => {
  ...
  function pcInjectStyle(){
    ...
    style.textContent = `
      ...
      .pc-check-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}.pc-check{display:flex;align-items:flex-start;gap:10px;padding:11px 12px;border:1px solid #dfe6ef;border-radius:12px;background:#fafcff;cursor:pointer;font-family:Inter,Arial,"Segoe UI",sans-serif!important;font-size:14px!important;font-weight:600!important;line-height:1.45!important;letter-spacing:0!important;text-transform:none!important;color:#2d4058!important;text-align:left!important}.pc-check>span{font-family:Inter,Arial,"Segoe UI",sans-serif!important;font-size:14px!important;font-weight:600!important;line-height:1.45!important;letter-spacing:0!important;text-transform:none!important;color:#2d4058!important}.pc-check input{margin-top:2px;accent-color:#0f6db8}
      ...
      .pc-shell,.pc-shell button,.pc-shell input,.pc-shell select,.pc-shell textarea{font-family:Inter,Arial,"Segoe UI",sans-serif!important}.pc-panel h3{font-weight:700!important;letter-spacing:0!important}.pc-field label,.pc-label{font-weight:700!important;letter-spacing:.015em!important}.pc-field textarea{font-size:14px!important;line-height:1.5!important}.pc-head h2{font-weight:700!important;letter-spacing:0!important}
